...
V11098_ID = "lev-v11098-2ddc1d07c9cfe31e"
V11800_ID = "lev-v11800-90804cea426c9753"
...
POOL_ALLOCATIONS = {V11098_ID: 1.0}
PAPER_ADMISSION_STATES = {
    V1254_ID: "DISABLED_BY_USER_2026_09_04",
    ...
    V10824_ID: "REJECTED_NONCAUSAL_EARLY_FILL_BEFORE_ROUTE_RESOLUTION",
    V11098_ID: "ACTIVE_PARITY_PROVEN",
    V11800_ID: "REJECTED_CUMULATIVE_BONFERRONI_GATE",
}
...
def validate_pool_allocations() -> None:
    if set(POOL_ALLOCATIONS) != {V11098_ID}:
