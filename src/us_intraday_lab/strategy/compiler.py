...
from us_intraday_lab.strategy.operators import (
    ...
    feature_pair_prior_session_return_min,
    feature_peer_prior_session_return,
    feature_peer_return_from_open,
    feature_peer_trailing_session_return_5,
    feature_prior_session_return,
    feature_range_position,
    feature_relative_return_from_open,
    feature_return_1,
    feature_return_3,
    feature_return_from_open,
    feature_rsi,
    feature_trailing_session_return_3,
    feature_trailing_session_return_5,
...
_INDICATOR_DISPATCH: Mapping[str, IndicatorFn] = MappingProxyType(
    {
        ...
        "return_from_open": feature_return_from_open,
        "prior_session_return": feature_prior_session_return,
        "trailing_session_return_3": feature_trailing_session_return_3,
        "trailing_session_return_5": feature_trailing_session_return_5,
        "peer_return_from_open": feature_peer_return_from_open,
        "relative_return_from_open": feature_relative_return_from_open,
        "peer_prior_session_return": feature_peer_prior_session_return,
        "pair_prior_session_return_min": feature_pair_prior_session_return_min,
        "peer_trailing_session_return_5": feature_peer_trailing_session_return_5,
        "is_tqqq": feature_is_tqqq,
        "is_soxl": feature_is_soxl,
