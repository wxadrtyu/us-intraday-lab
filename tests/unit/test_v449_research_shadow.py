...
from us_intraday_lab.v449_research_shadow import V449ShadowObservation


def test_v449_shadow_record_preserves_every_exception_and_has_no_order_fields() -> None:
    ...
    observation = V449ShadowObservation(
        session_date=date(2026, 8, 24),
        anchor=anchor,
    ...
    assert record["candidate_id"] == "lev-v449-03e9e3f9c4b21390"
