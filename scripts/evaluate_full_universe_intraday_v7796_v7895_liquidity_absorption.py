"""v7796-v7895: selective pre-route liquidity-absorption sleeve."""
...
FIRST_VERSION = 7796
LAST_VERSION = 7895
PRIOR_COMPARISON_CELLS = 256_666
ABSORPTION_SLOT = (11, 23)
ABSORPTION_FAMILY = "liquidity_absorption"
ABSORPTION_QUANTILE = 0.70
...
def _configure():
    ...
    campaign.campaign.EXTRA_COMPONENT_DEFINITION.update(
        {
            "type": "nonoverlapping_preroute_liquidity_absorption",
            "late_route_entry": 24,
        }
    )
