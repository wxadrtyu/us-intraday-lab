...
Register-ScheduledTask `
    -TaskName "USIntradayLab-V247-V449-AlpacaPaperPool" `
    -Description "Frozen 50/50 v247/v449 Alpaca Paper pool; paper endpoint only; gross <= 0.99." `
    -Action $runnerAction `
...
$closeTriggerStandard = New-ScheduledTaskTrigger `
    ...
    -At "04:45"
Register-ScheduledTask `
    -TaskName "USIntradayLab-V247-V449-AlpacaPaperPool-Closeout" `
    -Description "DST-safe closeout for the v247/v449 Alpaca Paper pool." `
    -Action $closeAction `
