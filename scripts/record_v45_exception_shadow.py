"""Append one completed v45 prospective observation without any broker route."""
...
from us_intraday_lab.v45_research_shadow import SYMBOLS, evaluate_v45_shadow_session
...
def main() -> None:
    ...
    observation = evaluate_v45_shadow_session(bars, session_date=args.session_date)
        ...
        json.dumps(
            {
                ...
                "selected_symbol": observation.selected_symbol,
