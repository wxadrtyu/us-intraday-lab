"""Run the frozen CFTC positioning training feasibility diagnostic."""
...
from us_intraday_lab.cftc_positioning_feasibility import run_diagnostic
...
def main() -> None:
    ...
    markdown = render_markdown(summary).replace(
        "Cboe Volatility-Regime", "CFTC Positioning"
    )
