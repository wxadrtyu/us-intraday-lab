"""Append one completed v449 prospective observation without any broker route."""
...
from us_intraday_lab.v449_research_shadow import evaluate_v449_shadow_session
...
def main() -> None:
    ...
    observation = evaluate_v449_shadow_session(bars, session_date=args.session_date)
