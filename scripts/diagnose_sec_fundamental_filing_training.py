"""Run the frozen SEC fundamental-filing training diagnostic."""
...
from us_intraday_lab.sec_fundamental_filing_feasibility import run_diagnostic
...
def main() -> None:
    ...
    markdown = render_markdown(summary).replace(
        "Cboe Volatility-Regime", "SEC Fundamental Filing"
    )
