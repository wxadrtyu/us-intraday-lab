"""Run the frozen SEC Form 4 insider-flow training diagnostic."""
...
from us_intraday_lab.sec_form4_insider_flow_feasibility import run_diagnostic
...
def main() -> None:
    ...
    markdown = render_markdown(summary).replace(
        "Cboe Volatility-Regime", "SEC Form 4 Insider-Flow"
    )
