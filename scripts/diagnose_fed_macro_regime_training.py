"""Run the frozen Federal Reserve macro-regime training diagnostic."""
...
from us_intraday_lab.fed_macro_regime_feasibility import run_diagnostic
...
def main() -> None:
    ...
    _write_immutable(arguments.output_json, (json.dumps(summary, indent=2, sort_keys=True) + "\n").encode())
    markdown = render_markdown(summary).replace("Cboe Volatility-Regime", "Federal Reserve Macro-Regime")
