"""Run the frozen SEC 8-K structured-event training diagnostic."""
...
from us_intraday_lab.sec_8k_event_feasibility import run_diagnostic
...
def main() -> None:
    ...
    markdown = render_markdown(summary).replace(
        "Cboe Volatility-Regime", "SEC 8-K Structured-Event"
    )
