...
Register-ScheduledTask `
    -TaskName "USIntradayLab-V247-V449-V798-V1254-AlpacaPaperPool" `
    -Description "Frozen equal-capital v247/v449/v798/v1254 Alpaca Paper pool; gross <= 0.99." `
    -Action $runnerAction `
...
$closeTriggerStandard = New-ScheduledTaskTrigger `
    ...
    -At "04:45"
Register-ScheduledTask `
    -TaskName "USIntradayLab-V247-V449-V798-V1254-AlpacaPaperPool-Closeout" `
    -Description "DST-safe closeout for the v247/v449/v798/v1254 Alpaca Paper pool." `
    -Action $closeAction `
...
Disable-ScheduledTask -TaskName "USIntradayLab-V247-V449-V798-AlpacaPaperPool" -ErrorAction SilentlyContinue | Out-Null
Disable-ScheduledTask -TaskName "USIntradayLab-V247-V449-V798-AlpacaPaperPool-Closeout" -ErrorAction SilentlyContinue | Out-Null
